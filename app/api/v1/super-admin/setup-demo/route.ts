  ...
  try {
    ...
    try {
      ...
      if (waseemTenant) {
        ...
        console.log('✅ Waseem tenant deleted')
      } else {
    ...
    // Create categories and products (abbreviated for API response)
    ...
    // Continue with pizza, mains, desserts, beverages...
    ...
    console.log('✅ Coffee shop menu created')
        ...
        created: [
          {
            ...
            slug: 'labellaitalia',
            admin: 'admin@labellaitalia.com',
            password: '123456',
            url: 'https://themenugenie.com/menu/labellaitalia',
            categories: 6,
            products: 27
          },
          {
            name: 'Café Aroma',
            slug: 'cafearoma',
            admin: 'admin@cafearoma.com',
            password: '123456',
            url: 'https://themenugenie.com/menu/cafearoma',
            categories: 6,
            products: 30
          }
        ]
    ...
    return NextResponse.json(
      { success: false, message: error.message || 'Failed to create demo menus' },
      { status: 500 }
    )
  }
}
